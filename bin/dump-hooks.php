 ...
 * 	       wp eval-file wp-content/plugins/notification-bbpress/bin/dump-hooks.php
 *
 * @package notification/bbpress
 */

$runtime    = NotificationbbPress::runtime();
...
$objects = [];
foreach ( NotificationbbPress::components() as $component_name => $instance ) {
